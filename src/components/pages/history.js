      ...
      <div>
        ...
        <div>
          ...
          <div className='body body--history'>
            ...
            {tab === 'heating' && thermostats.map(thermostat => <HeatingHistory id={thermostat.id} name={thermostat.name} />)}
            {tab === 'lighting' && lights.map(light => <LightingHistory id={light.id} name={light.name} />)}
          </div>
        </div>
